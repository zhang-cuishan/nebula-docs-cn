...
1. 根据需要选择并下载RPM包，建议选择最新版本。常用下载链接如下：
   ...
   | ----- | ----- | ----- |
   | [nebula-graph-studio-2.2.2-1.x86_64.rpm](https://oss-cdn.nebula-graph.com.cn/nebula-graph-studio/nebula-graph-studio-2.2.2-1.x86_64.rpm) |  [nebula-graph-studio-2.2.2-1.x86_64.rpm.sha256](https://oss-cdn.nebula-graph.com.cn/nebula-graph-studio/nebula-graph-studio-2.2.2-1.x86_64.rpm.sha256) | 2.0.1 |
...
2. 使用`sudo rpm -i <rpm>`命令安装RPM包。
   ...
   ```bash
   $ sudo rpm -i nebula-graph-studio-2.2.2-1.x86_64.rpm
   ```
