...
1. 根据需要下载 TAR 包，建议选择最新版本。
  ...
  !!! enterpriseonly
        ...
        用户可以[在线申请](https://wj.qq.com/s2/10158890/69a8)试用 Dashboard 企业版；如需购买，请[联系我们](https://nebula-graph.com.cn/contact)。点击[定价](https://nebula-graph.com.cn/pricing/)查看更多。
