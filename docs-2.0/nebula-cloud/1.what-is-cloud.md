...
使用 Cloud 需要同时购买查询引擎（Query Engine）和存储引擎（Storage Engine）。具体配置价格查看 [定价](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/vesoftcompanylimited1625556994617.nebula_graph_cloud?tab=PlansAndPrice) 页面。
